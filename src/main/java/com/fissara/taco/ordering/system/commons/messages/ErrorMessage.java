...
public class ErrorMessage {
    ...
    public static final String CUSTOMER_IS_REQUIRED_ERROR = "Customer is required";
    ...
    public static final String INVALID_INGREDIENT_NAME_ERROR = "Ingredient name is required at least 5 characters";
